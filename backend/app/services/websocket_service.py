...
class WebSocketManager:
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            if not all(
                ...
                logger.error(
                    "Missing authentication tokens or smart_api instance for WebSocket"
                )
                return False
    ...
    async def subscribe_to_instruments(
        self, instruments: List[Dict[str, str]], mode: int = 1
    ):
        """
        ...
        try:
            ...
            for instrument in instruments:
                ...
                self.subscribed_tokens[token] = {"exchange": exchange, "mode": mode}
    ...
    def _get_exchange_type(self, exchange: str) -> int:
        ...
        exchange_map = {"NSE": 1, "BSE": 6, "NFO": 2, "CDS": 5, "MCX": 4}
    ...
    def _resubscribe_all(self):
        ...
        for group_info in resubscribe_groups.values():
            ...
            token_list = [
                {"exchangeType": exchange_type, "tokens": group_info["tokens"]}
            ]
    ...
    async def unsubscribe_from_instruments(self, instruments: List[Dict[str, str]]):
        ...
        try:
            ...
            for exchange, tokens in exchange_groups.items():
                ...
                logger.info(
                    f"Unsubscribed from {len(tokens)} instruments on {exchange}"
                )
