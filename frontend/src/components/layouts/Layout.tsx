...
export function Layout({ children }: LayoutProps) {
  ...
  return (
    <>
      <Head>
        <title>
          SSA - Smart Sentiment Analysis | AI-Powered Investment Intelligence
        </title>
        <meta
          name="description"
          content="Transform your investment strategy with AI-powered sentiment analysis. Get real-time market insights and data-driven recommendations for smarter trading decisions."
        />
        <link
          rel="icon"
